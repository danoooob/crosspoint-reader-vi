...
namespace {
constexpr uint8_t SECTION_FILE_VERSION = 17;  // Version 17: optimized image scaling (pre-scale during conversion)
...
bool Section::createSectionFile(const int fontId, const float lineCompression, const bool extraParagraphSpacing,
  ...
  ChapterHtmlSlimParser visitor(
      tmpHtmlPath, *epub, renderer, fontId, lineCompression, extraParagraphSpacing, paragraphAlignment, viewportWidth,
      viewportHeight,
